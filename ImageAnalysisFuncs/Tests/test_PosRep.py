...
class TestPosRepImageAnalysis(unittest.TestCase):
    ...
    def test_expected(self):
        cases = [("../TestImages/PT25_posrep_1_001.bmp", 45.833,  30.703,  0.892,  44.083,  29.115,  0.904),
                 ("../TestImages/PT25_posrep_1_002.bmp", 45.830,  30.699,  0.886,  44.081,  29.111,  0.899),
                 ("../TestImages/PT25_posrep_1_003.bmp", 45.831,  30.700,  0.895,  44.080,  29.111,  0.898),
                 ("../TestImages/PT25_posrep_1_004.bmp", 45.156,  30.715,  0.894,  43.419,  29.113,  0.898),
                 ("../TestImages/PT25_posrep_1_005.bmp", 45.152,  30.717,  0.888,  43.418,  29.112,  0.903),]
