...
task_dependencies = [
    ...
    (T.TST_INITPOS, []),
    (T.TASK_REWIND_FPUS, [T.TASK_INIT_GD]),
    (T.TASK_PARK_FPUS, [T.TASK_INIT_GD2]),
    (T.TASK_REFERENCE, [T.TASK_INIT_GD]),
    (T.TASK_RESET_FPUS, [T.TASK_INIT_GD]),
    (T.TASK_HOME_TURNTABLE, [T.TASK_INIT_GD]),
    (
        T.TASK_SELFTEST,
        [T.TASK_SELFTEST_NONFIBRE, T.TASK_SELFTEST_FIBRE, T.TASK_HOME_TURNTABLE],
    ),
    (
        T.TASK_SELFTEST_NONFIBRE,
        [
...
task_expansions = [
    ...
    (T.TST_LIMITS, [T.TST_COLLDETECT, T.TST_LIMITS_ALPHA, T.TST_LIMITS_BETA]),
